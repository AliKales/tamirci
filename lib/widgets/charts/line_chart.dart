...
class CLineChart extends StatefulWidget {
  ...
  @override
  State<CLineChart> createState() => _CLineChart();
}

class _CLineChart extends State<CLineChart> {
  List<int> showingTooltipOnSpots = [];

  int get _getDataLength => widget.datas.length;

  List<MapEntry<String, double>> get _datas => widget.datas;

  List<FlSpot> get allSpots => List.generate(
        _getDataLength,
        (index) => FlSpot(
          index.toDouble(),
          _datas[index].value,
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: 0.8.toDynamicWidth(context),
      width: 1.toDynamicWidth(context),
      child: Padding(
